    ...
    <div className="relative">
      ...
      {items.map((item, index) => (
        <div key={index} className="relative flex items-start mb-8 group">
          ...
          <div className="ml-12 w-full min-h-36 bg-white dark:bg-gray-800 rounded-lg p-6 shadow-lg border border-gray-200 dark:border-gray-700 group-hover:shadow-xl transition-shadow duration-200">
